<template>
  <div class="register">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
      <h3 class="title">Smart Store Management System</h3>
    ...
    <div class="el-register-footer">
      <span>Copyright © 2022 by Yu Yue 1001956834</span>
    </div>
  </div>
</template>
      ...
      this.$refs.registerForm.validate(valid => {
        if (valid) {
          ...
          register(this.registerForm).then(res => {
            ...
            this.$alert("<font color='red'>congratulations, your account " + username + "registration success!</font>", 'System hint', {
