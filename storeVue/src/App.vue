    ...
    <el-container>
          ...
          <ul>
            ...
            <li :class="getNum > 0 ? 'shopCart-full' : 'shopCart'">
              <router-link to="/shoppingCart">
                <i class="el-icon-shopping-cart-full"></i> Shop Cart
      ...
      <el-header>
        <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" active-text-color="#409eff"
          ...
          <div class="logo">
            <router-link to="/">
              <img style="    height: 56px;width: 288px;object-fit: scale-down;" src="./assets/imgs/logo.png" alt />
            </router-link>
          </div>
          <el-menu-item style="font-size:18px" index="/">Home</el-menu-item>
          <el-menu-item style="font-size:18px" index="/goods">All Products</el-menu-item>
             <el-menu-item style="font-size:18px" index="/leaving">Message</el-menu-item>
          <div class="so">
            <el-input placeholder="Please enter the search content" v-model="search">
        ...
        <div class="footer">
          <div class="ng-promise-box">
            <div class="ng-promise">
              <p class="text">
                <a class="icon1" href="javascript:;">Returnable within 72 hours</a>
                <a class="icon2" href="javascript:;">Official Authentic</a>
          ...
          <div class="mod_help">
            ...
            <p class="coty">Copyright &copy; 2022 by Yu Yue 1001956834</p>
          </div>
        </div>
      </el-footer>
