...
import com.game.common.annotation.RateLimiter;
...
public class RateLimiterAspect
{
    ...
    public void doBefore(JoinPoint point, RateLimiter rateLimiter) throws Throwable
    {
        ...
        try
        {
            ...
            log.info("Limit request '{}', current request '{}', cache key '{}'", count, number.intValue(), key);
        }
        ...
        {
            throw new RuntimeException("Server current limit is abnormal, please try again later");
        }
    }
