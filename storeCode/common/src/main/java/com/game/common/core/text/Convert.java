...
public class Convert
{
     ...
     * 1. Byte arrays and ByteBuffers will be converted to arrays of corresponding strings 2. Object arrays will call the Arrays.toString method
     *
     * @param obj object
     * @return string
     */
